---@type table
local Colour = {
    Background = { Dictionary = "illegal", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "illegal", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "illegal", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
