...
AddEventHandler('esx_jail:jailPlayer', function(_jailTime)
	...
	TriggerEvent('skinchanger:getSkin', function(skin)
		if skin.sex == 0 then
			TriggerEvent('skinchanger:loadClothes', skin, cfg_jail.Uniforms.prison_wear.male)
		else
			TriggerEvent('skinchanger:loadClothes', skin, cfg_jail.Uniforms.prison_wear.female)
		end
	end)
