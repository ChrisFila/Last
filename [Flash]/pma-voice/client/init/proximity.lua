...
local lFlashSidedioStatus = false
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if GetConvarInt('voice_enableUi', 1) == 1 then
			...
			if lFlashSidedioStatus ~= radioPressed or lastTalkingStatus ~= curTalkingStatus then
				lFlashSidedioStatus = radioPressed
				lastTalkingStatus = curTalkingStatus
				sendUIMessage({
					usingRadio = lFlashSidedioStatus,
