...
local items = {
    [1] = {name = "Hi-Fi", timeToTake = FlashSide.second(2), resellerPrice = 500, prop = "as_prop_as_speakerdock", itr = 1.0},
    [2] = {name = "Lampe", timeToTake = FlashSide.second(5), resellerPrice = 250, prop = "apa_mp_h_floorlamp_a", additionalZ = 1.50, itr = 1.0},
    [3] = {name = "Lampe", timeToTake = FlashSide.second(5), resellerPrice = 250, prop = "apa_mp_h_lit_floorlampnight_14", additionalZ = 1.50, itr = 1.0},
    [4] = {name = "Plante rare", timeToTake = FlashSide.second(4), resellerPrice = 150, prop = "apa_mp_h_acc_vase_flowers_01", additionalZ = 1.0, itr = 1.0},
    [5] = {name = "Appareil photo", timeToTake = FlashSide.second(2), resellerPrice = 1500, prop = "prop_pap_camera_01", itr = 1.0},
    [6] = {name = "Pack d'argent", timeToTake = FlashSide.second(1), resellerPrice = 3500, prop = "bkr_prop_moneypack_01a", itr = 1.0},
    [7] = {name = "Bijoux rare", timeToTake = FlashSide.second(2), resellerPrice = 5000, prop = "p_jewel_necklace01_s", itr = 1.0},
    [8] = {name = "Caisse d'argent", timeToTake = FlashSide.second(30), resellerPrice = 10000, prop = "ex_prop_crate_money_bc", itr = 4.0}
}

FlashSideSharedRobberiesInteriors = interiors
FlashSideSharedRobberiesItems = items

FlashSideSharedRobberies = {
    -- Maison 1 (diamant)
    {
        name = "Maison Diamant",
        interior = 1,
