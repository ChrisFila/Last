code_menu = false
local menu_code = RageUI.CreateMenu("Auto-école", "Options disponibles :")
...
examen_menu = false
local menu_examen = RageUI.CreateMenu("Auto-école", "Examen :")
local menu_examen_1 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_2 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_3 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_4 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_5 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_6 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_7 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_8 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_9 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_10 = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Réponses disponibles :")
local menu_examen_final = RageUI.CreateSubMenu(menu_examen, "Auto-école", "Résultat du code :")
                ...
                RageUI.IsVisible(menu_examen, function()
                    ...
                    RageUI.Button('Commencer le code de la route', nil, {RightLabel = ("→→")}, true, {
                        onSelected = function()
                            ...
                            timer_active = true
                            ESX.ShowNotification(("[~r~Information~s~] Vous commencez votre code de la route, vous avez ~g~%s minutes~s~."):format(ConfigAutoEcole.timer/60))
                        end
                    }, menu_examen_1)
                end)
                    ...
                    RageUI.Button('Je dégage la voix au plus vite', nil, {RightLabel = ("→→")}, true, {
                        onSelected = function()
                            ...
                            if ErreurPermis >= 3 then
                                ESX.ShowNotification(("[~r~Échoué~s~] Vous avez fait ~r~%s~s~ erreurs."):format(ErreurPermis))
                            else
                                ESX.ShowNotification(("[~g~Réussi~s~] Félicitaion, vous avez eu ~r~%s~s~ erreurs."):format(ErreurPermis))
