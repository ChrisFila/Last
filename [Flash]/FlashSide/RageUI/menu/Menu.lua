...
---@return table
---@public
function FlashSideUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = FlashSideUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = FlashSideUI.UI.Style[FlashSideUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = FlashSideUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + FlashSideUI.Settings.Items.Subtitle.Text.X, Menu.Y + FlashSideUI.Settings.Items.Subtitle.Text.Y, 0, FlashSideUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, FlashSideUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, FlashSideUI.Menus)
end
...
---@return table
---@public
function FlashSideUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function FlashSideUI.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function FlashSideUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function FlashSideUI.Menus:GetStyleSize()
...
---@return void
---@public
function FlashSideUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function FlashSideUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function FlashSideUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function FlashSideUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function FlashSideUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + FlashSideUI.Settings.Items.Subtitle.Text.X, self.Y + FlashSideUI.Settings.Items.Subtitle.Text.Y, 0, FlashSideUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, FlashSideUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function FlashSideUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function FlashSideUI.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function FlashSideUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function FlashSideUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function FlashSideUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function FlashSideUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function FlashSideUI.Menus:Closable(boolean)
...
function FlashSideUI.Menus:AddInstructionButton(button)
...
function FlashSideUI.Menus:RemoveInstructionButton(button)
...
function FlashSideUI.Menus:UpdateInstructionalButtons(Visible)
