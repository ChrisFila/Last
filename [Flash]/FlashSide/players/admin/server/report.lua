...
AddEventHandler("adminmenu:takeReport", function(reportId)
    ...
    notifyActiveStaff("~r~[Report] ~s~Le staff ~r~"..GetPlayerName(source).."~s~ a pris en charge le report ~r~n°"..reportsTable[reportId].uniqueId)
...
AddEventHandler("adminmenu:closeReport", function(reportId)
    ...
    notifyActiveStaff("~r~[Report] ~s~Le staff ~r~"..GetPlayerName(source).."~s~ a ~r~cloturé ~s~le report ~r~n°"..reportsTable[reportId].uniqueId)
...
RegisterCommand("report", function(source, args)
    ...
    notifyActiveStaff("~r~[Report] ~s~Un nouveau report a été reçu. ID Unique: ~r~" .. reportsCount)
