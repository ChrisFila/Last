...
RegisterNetEvent("FlashSideUI:Popup")
AddEventHandler("FlashSideUI:Popup", function(array)
    FlashSideUI.Popup(array)
end)

---Popup
---@param array table
---@public
function FlashSideUI.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function FlashSideUI.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
...
---@param array table
---@public
function FlashSideUI.Text(array)
    ClearPrints()
