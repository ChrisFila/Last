Locales['fr'] = {
	...
	['gave_weapon_ammo'] = 'vous avez donné ~o~%sx~s~ balles pour ~r~%s~s~ à ~r~%s~s~',
	['gave_weapon_withammo'] = 'vous avez donné ~r~1x~s~ ~r~%s~s~ avec ~o~%sx~s~ balles à ~r~%s~s~',
	...
	['received_weapon_ammo'] = 'vous avez reçu ~o~%sx~s~ balles pour votre ~r~%s~s~ de ~r~%s~s~',
	['received_weapon_withammo'] = 'vous avez reçu ~r~1x~s~ ~r~%s~s~ avec ~o~%sx~s~ balles de ~r~%s~s~',
	...
	['gave_money'] = 'vous avez donné ~r~$%s~s~ à ~r~%s~s~',
	['received_money'] = 'vous avez reçu ~r~$%s~s~ par ~r~%s~s~',
	...
	['money_set'] = 'quelqu\'un de ~r~haut placé~s~ vous a attribué ~r~$%s~s~ (%s) !',
