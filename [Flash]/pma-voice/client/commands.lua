...
RegisterCommand('cycleproximity', function()
	...
	Citizen.CreateThread(function()
		...
		while i < 15 do
			Citizen.Wait(0)
			i = i + 1
			DrawMarker(1, GetEntityCoords(PlayerPedId()) - vector3(0, 0, 0.9), 0, 0, 0, 0, 0, 0, Cfg.voiceModes[mode][1] * 2.0, Cfg.voiceModes[mode][1] * 2.0, 0.8001, 0, 75, 255, 165, 0,0, 0,0)
		end
	end)
end, false)
if gameVersion == 'fivem' then
	RegisterKeyMapping('cycleproximity', 'Voix a distance', 'keyboard', GetConvar('voice_defaultCycle', 'F11'))
end
